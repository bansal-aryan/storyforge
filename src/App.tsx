...
export default function App() {
  ...
  useEffect(() => {
    ...
    const tick = (time: number) => {
      ...
      if (time - autonomyTickRef.current > 1100) { autonomyTickRef.current = time; engine.runTrustedAutonomy(); }
